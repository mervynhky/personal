...
(function () {
    var t = this, n = function () {
        ...
        function u(t, n) {
            var i = h.prototype.filter, r = t._filterArgs;
            e(i, function (e) {
        ...
        var f, p, l = "linear", _ = 500, m = 1e3 / 60, w = Date.now ? Date.now : function () {
            return +new Date
        ...
        return h.prototype.tween = function (t) {
            ...
            var o = this._currentState, a = this._targetState;
    ...
    (function () {
        ...
        e._filterArgs = [], n.interpolate = function (i, r, o, a, u) {
            var s = n.shallowCopy({}, i), c = u || 0, h = n.composeEasingObject(i, a || "linear");
            e.set({});
            var f = e._filterArgs;
        ...
        function s(t, n, e) {
            var i = n.match(t), r = n.replace(t, O);
            if (i)for (var o, a = i.length, u = 0; a > u; u++)o = i.shift(), r = r.replace(O, e(o));
            return r
        }
        ...
        function f(i) {
            ...
            return t.each(i, function (t) {
                ...
                if ("string" == typeof o) {
                    var a = d(o);
                    r[t] = {formatString: e(o), chunkNames: n(a, t)}
                }
            }), r
        }
        ...
        function l(n, e) {
            t.each(e, function (t) {
                var i = n[t], r = _(n, e[t].chunkNames), o = m(r, e[t].chunkNames);
        ...
        function g(n, e) {
            t.each(e, function (t) {
                var i, r = e[t], o = r.chunkNames, a = o.length, u = n[t];
                if ("string" == typeof u) {
                    var s = u.split(" "), c = s[s.length - 1];
                    for (i = 0; a > i; i++)n[o[i]] = s[i] || c
                } else for (i = 0; a > i; i++)n[o[i]] = u;
                delete n[t]
            })
        }
        ...
        function y(n, e) {
            t.each(e, function (t) {
                var i = e[t], r = i.chunkNames, o = r.length, a = n[r[0]], u = typeof a;
                if ("string" === u) {
        ...
        var v = /(\d|\-|\.)/, M = /([^\-0-9\.]+)/g, F = /[0-9.\-]+/g, T = RegExp("rgb\\(" + F.source + /,\s*/.source + F.source + /,\s*/.source + F.source + "\\)", "g"), I = /^.*\(/, S = /#([0-9]|[a-f]){3,6}/gi, O = "VAL", b = [], k = [];
...
;(function (factory) {
    ...
    jQuery.nanoGallery.defaultOptions = {
        ...
        i18n: {
            ...
            'infoBoxPhoto_ES': 'Foto',
            'infoBoxDate_ES': 'Fecha',
            'infoBoxAlbum_ES': 'Album',
            'infoBoxDimensions_ES': 'Dimensiones',
            'infoBoxFilename_ES': 'Nombre',
            'infoBoxFileSize_ES': 'Tama&ntilde;o',
            'infoBoxCamera_ES': 'C&aacute;mara',
            'infoBoxFocalLength_ES': 'Longitud focal',
            'infoBoxExposure_ES': 'Exposici&oacute;n',
            'infoBoxFNumber_ES': 'N&uacute;mero F',
            'infoBoxISO_ES': 'ISO',
            'infoBoxMake_ES': 'Hacer',
            'infoBoxFlash_ES': 'Flash',
            'infoBoxViews_ES': 'Vistas',
            'infoBoxComments_ES': 'Comentarios'
        }
    };
    ...
    function nanoGALLERY() {
        ...
        function ProcessItemOption() {
            ...
            jQuery.each(G.O.items, function (i, item) {
                ...
                newItem.thumbs = {
                    url: {
                        l1: {xs: thumbsrc, sm: thumbsrc, me: thumbsrc, la: thumbsrc, xl: thumbsrc},
            ...
            jQuery.each(data, function (i, item) {
                ...
                if (ok) {
                    ...
                    newItem.thumbs = {
                        ...
                        width: {
                            l1: {xs: tw, sm: tw, me: tw, la: tw, xl: tw},
                            lN: {xs: tw, sm: tw, me: tw, la: tw, xl: tw}
                        },
                        height: {
                            l1: {xs: th, sm: th, me: th, la: th, xl: th},
                            lN: {xs: th, sm: th, me: th, la: th, xl: th}
                        }
                    };
        ...
        function FlickrRetrieveImages(tn, item, level) {
            ...
            for (var i = 0; i < sizes.length; i++) {
                ...
                else if (G.tn.settings.height[level][sizes[i]] == 'auto') {
                    var sdir = 'width_';
                ...
                switch (G.O.imageTransition) {
                    ...
                    case 'slideOLD':
                        ...
                        if (G.CSStransformName == null) {
                            ...
                            var to = {v: (displayType == 'nextImage' ? -getViewport().w : getViewport().w)};
                            jQuery(from).animate(to, {
                                duration: 400, easing: 'linear', step: function (currentValue) {
                                    window.requestAnimationFrame(function () {
                                        G.$E.vwImgC[0].style[G.CSStransformName] = 'translateX(' + currentValue + 'px)';
                                        //G.$E.vwImgC.css({ opacity: (1-Math.abs(currentValue/dir)) });
                                        $new[0].style[G.CSStransformName] = 'translateX(' + (-dir + currentValue) + 'px) '
        ...
        function OpenFancyBox(imageIdx) {
            ...
            if (G.O.fancyBoxOptions != null) {
                ...
                jQuery.fancybox(lstImages, {
                    'autoPlay': false, 'nextEffect': 'fade', 'prevEffect': 'fade', 'scrolling': 'no',
